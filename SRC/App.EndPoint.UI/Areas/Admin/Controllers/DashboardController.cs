...
namespace App.EndPoint.UI.Areas.Admin.Controllers
{
    ...
    public class DashboardController : Controller
    {
        ...
        {
            var model = await _userManager.Users.Select(x=>new Usermanagmentviewmodel
            {
                Id = x.Id,
                UserName = x.UserName,
        ...
        {
            var user = _userManager.Users.FirstOrDefault(u => u.Id == id);
            Usermanagmentviewmodel u = new Usermanagmentviewmodel();
        ...
        {
            var user = _userManager.Users.FirstOrDefault(u => u.Id == id);
            Usermanagmentviewmodel x = new Usermanagmentviewmodel();
        ...
        [HttpPost]
        public async Task<IActionResult> Edit(Usermanagmentviewmodel userVmodel)
        {
